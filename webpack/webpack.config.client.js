...
module.exports = {
  ...
  module: {
    rules: [
      ...
      {
        test: /\.jpg|png|ico|gif|woff|eot|ttf|svg|mp4|webm$/,
        use: {
          loader: 'file-loader',
          options: {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      'process.env.BASE_URL_PROXY': JSON.stringify(process.env.BASE_URL_PROXY),
      'process.env.CLIENT_ID_GOOGLE': JSON.stringify(process.env.CLIENT_ID_GOOGLE),
